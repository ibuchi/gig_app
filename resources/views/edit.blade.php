...
<div>
    <form method="POST" action="{{ route('gigs.update', $gig) }}">
        ...
        <div class="space-y-12">
            <div class="mt-10 grid grid-cols-1 gap-y-8 gap-x-6 sm:grid-cols-6">
                ...
                <div class="mt-2">
                    ...
                    <option value="country" selected hidden>{{ $gig->country }}</option>
                ...
                <div class="mt-8">
                    ...
                    <option value="state" selected hidden>{{ $gig->state }}</option>
                ...
                <div class="mt-2">
                    <input type="text" name="address" id="address" autocomplete="address" placeholder="Address" value="{{ $gig->address }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
                </div>
                ...
                <div class="mt-2">
                    <input type="text" name="tags" id="tags" autocomplete="tags" placeholder="Add tags" value="{{ $gig->tags }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
                </div>
                ...
                <div class="mt-2">
                    <input type="text" name="minimum_salary" id="minimum_salary" autocomplete="given-salary" placeholder="minimum" value="{{ $gig->minimum_salary }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
                </div>
                <div class="sm:col-span-3">
                <div class="mt-8">
                    <input type="text" name="maximum_salary" id="maximum_salary" autocomplete="given-salary" placeholder="maximum" value="{{ $gig->maximum_salary }}" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                </div>
                </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button type="submit" class="rounded-md bg-indigo-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Update gig</button>
        </div>
    </form>
</div>
