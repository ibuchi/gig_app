    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gray-100">
            ...
            <div class="min-h-screen flex antialiased bg-gray-50 text-gray-800">
                <div class="top-0 left-0 w-64 bg-white min-h-screen border-r">
                    ...
                    <ul class="flex flex-col py-4 space-y-1">
                        ...
                        <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-yellow-500 hover:text-gray-800 border-l-4 border-transparent pr-6">
                            ...
                            <span class="ml-2 text-sm tracking-wide truncate">Gigs</span>
                        </a>
                        </li>
                        <li>
                        <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-yellow-500 pr-6">
                ...
                <!-- component -->
                <div class="flex-1 max-w-7xl mx-auto bg-white">
                    <nav class="flex justify-between px-20 py-10 items-center bg-white border-b">
                        <div class="flex items-center border">
                            ...
                            <input class="ml-2 outline-none bg-transparent focus:ring-0 focus:border-white border-transparent font-" type="text" name="search" id="search" placeholder="Search..." />
                        </div>
                        <div class="flex items-center">
                            ...
                            <li>
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M22 5.01H2c-.55 0-1 .45-1 1v11.98c0 .55.45 1 1 1h20c.55 0 1-.45 1-1V6.01c0-.55-.45-1-1-1zm0 2.49L12 13.47 2 7.5v9.99l10-6.03 10 6.03V7.5z"/>
                                </svg>
                            </li>
                            <li>
                                <img class="w-6 h-6 rounded-full border" src="https://images.statusfacebook.com/profile_pictures/stylish-boys/boys-profile-pics-742.jpg" alt="gig">
                            </li>
                            </ul>
                        </div>
                    </nav>
